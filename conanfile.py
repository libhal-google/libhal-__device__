...
class LibbasisConan(ConanFile):
    name = "libbasis"
    version = "0.1.0"
    license = "Apache-2.0"
    url = "https://github.com/conan-io/conan-center-index"
    homepage = "https://libhal.github.io/libbasis"
    description = ("This is a template library for making libhal libraries")
    topics = ("libhal", "template", "demo")
    settings = "compiler"
